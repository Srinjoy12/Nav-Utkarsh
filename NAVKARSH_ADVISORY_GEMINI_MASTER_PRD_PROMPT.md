# PRD & GEMINI MASTER PROMPT: NAVKARSH ADVISORY (ULTRA-PREMIUM WEBSITE REBUILD)

> **Overview**: This document contains the complete Product Requirement Document (PRD) and a master prompt specifically optimized for **Google Gemini** (Gemini Advanced / Gemini 1.5 Pro / Gemini 2.0 / Gemini 3.5) to build an award-winning, hyper-modern, interactive website for **Navkarsh Advisory** (Dr. Sumit Roy).
...
## PART 2: THE COMPLETE GEMINI MASTER PROMPT

> **Instructions**: Copy the entire prompt box below and paste it into **Google Gemini** (Gemini Advanced / Gemini 1.5 Pro / Gemini 2.0 / Gemini 3.5). Gemini’s large context and strong creative coding ability will generate complete, ultra-polished code files.
